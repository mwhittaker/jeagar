...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/mwhittaker/collatz/collatz/Even",
		Iface: reflect.TypeOf((*Even)(nil)).Elem(),
		Impl:  reflect.TypeOf(even{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return even_local_stub{impl: impl.(Even), tracer: tracer, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/collatz/collatz/Even", Method: "Do", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return even_client_stub{stub: stub, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/collatz/collatz/Even", Method: "Do", Remote: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦837d10a2:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/mwhittaker/collatz/collatz/Odd⟧\n⟦45cd85e2:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/mwhittaker/collatz/collatz/Even⟧\n⟦f3b62957:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→collatz⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "github.com/mwhittaker/collatz/collatz/Odd",
		Iface: reflect.TypeOf((*Odd)(nil)).Elem(),
		Impl:  reflect.TypeOf(odd{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return odd_local_stub{impl: impl.(Odd), tracer: tracer, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/collatz/collatz/Odd", Method: "Do", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return odd_client_stub{stub: stub, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/mwhittaker/collatz/collatz/Odd", Method: "Do", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
